...
namespace Unity.BossRoom.Gameplay.GameplayObjects.Character
{
    ...
    public class ServerCharacter : NetworkBehaviour, ITargetable
    {
        ...
        /// </summary>
        /// <param name="inflicter">Person dishing out this damage/healing. Can be null. </param>
        /// <param name="Mana">The HP to receive. Positive value is healing. Negative is damage.  </param>
        void ReceiveMana(ServerCharacter inflicter, int Mana)
        {
            m_ServerActionPlayer.OnGameplayActivity(Action.GameplayActivity.ReceivedMana);
